...
const addEmployee = () => {
    inquirer.prompt([
        ...
        db.query(sql, {first_name: response.firstName, last_name: response.lastName, role_id: response.role[0], manager_id: response.manager})
        end()        
    })
...
const addRole = () => {
    inquirer.prompt([
        ...
        db.query(sql, {job_title: response.role, salary: response.salary, dept_id: response.deptId})
        end()        
    })
}
const addDepartment = () => {
    inquirer.prompt([
        ...
        db.query(sql, {dept_name: response.dept})
        end()
    })
}
